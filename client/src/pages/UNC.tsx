    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-10 md:py-14">
        <div className="container mx-auto max-w-3xl px-4 md:px-6">
          <h2 className="font-heading text-3xl font-semibold mb-4 text-center">
            Latest Fridge Status
          </h2>
          <p className="text-muted-foreground text-center mb-8">
            The most recent updates on the UNC fridge, uploaded by community
            members. Click 'check-in' below to update fridge status.
          </p>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      <br /> Saturday: 9:00 AM - 11:00 PM
                      <br /> Sunday: 11:00 AM - 11:00 PM
                    </p>
                  </div>
                </div>
